...
int main() {
    ...
    float s2_percentage = calculate_percentage(s2_total_marks);
    ...
    int s3_total_marks = calculate_sum_of_marks(s3_math_marks, s3_science_marks, s3_english_marks);
    float s3_percentage = calculate_percentage(s3_total_marks);
