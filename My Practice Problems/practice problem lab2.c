#include<stdio.h>
int calculate_sum_of_marks(int s1_math_marks , int s1_science_marks, int s1_english_marks, int s2_math_marks, int s2_science_marks, int s2_english_marks, int s3_math_marks, int s3_science_marks, int s3_english_marks)
float percentage(int sum_of_marks);
...
int main(){
 ...
 int calculate_sum_of_marks(s1_math_marks , s1_science_marks, s1_english_marks)
 {
 	return math_marks + science_marks + english_marks;
 }
 float percentage(int sum_of_marks)
 {
 	return (sum_of_marks * 100) /300 ;
 }
